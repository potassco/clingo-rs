...
pub struct clingo_propagator {
    pub init: ::std::option::Option<unsafe extern "C" fn(control:
                                                             *mut clingo_propagate_init_t,
                                                         data:
                                                             *mut ::std::os::raw::c_void)
                                        -> u8>,
...
impl clingo_ast_term {
    ...
    pub unsafe fn unary_operation(&mut self)
     -> *mut *const clingo_ast_unary_operation_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn binary_operation(&mut self)
     -> *mut *const clingo_ast_binary_operation_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn external_function(&mut self)
     -> *mut *const clingo_ast_function_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
...
impl clingo_ast_literal {
    ...
    pub unsafe fn comparison(&mut self)
     -> *mut *const clingo_ast_comparison_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn csp_literal(&mut self)
     -> *mut *const clingo_ast_csp_literal_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
impl clingo_ast_theory_term {
    ...
    pub unsafe fn tuple(&mut self)
     -> *mut *const clingo_ast_theory_term_array_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn function(&mut self)
     -> *mut *const clingo_ast_theory_function_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn unparsed_term(&mut self)
     -> *mut *const clingo_ast_theory_unparsed_term_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
impl clingo_ast_head_literal {
    ...
    pub unsafe fn disjunction(&mut self)
     -> *mut *const clingo_ast_disjunction_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn head_aggregate(&mut self)
     -> *mut *const clingo_ast_head_aggregate_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn theory_atom(&mut self)
     -> *mut *const clingo_ast_theory_atom_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
impl clingo_ast_body_literal {
    ...
    pub unsafe fn conditional(&mut self)
     -> *mut *const clingo_ast_conditional_literal_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn aggregate(&mut self) -> *mut *const clingo_ast_aggregate_t {
    ...
    pub unsafe fn body_aggregate(&mut self)
     -> *mut *const clingo_ast_body_aggregate_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn theory_atom(&mut self)
...
impl clingo_ast_statement {
    ...
    pub unsafe fn definition(&mut self)
     -> *mut *const clingo_ast_definition_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn show_signature(&mut self)
     -> *mut *const clingo_ast_show_signature_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn project_atom(&mut self)
     -> *mut *const clingo_ast_project_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn theory_definition(&mut self)
     -> *mut *const clingo_ast_theory_definition_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_1_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type clingo_finish_callback_t =
    ::std::option::Option<unsafe extern "C" fn(result:
                                                   clingo_solve_result_bitset_t,
                                               data:
                                                   *mut ::std::os::raw::c_void)
                              -> u8>;
#[link(name = "gringo", kind = "dylib")]
extern "C" {
    ...
    pub fn clingo_warning_string(code: clingo_warning_t)
     -> *const c_char;
    pub fn clingo_version(major: *mut c_int,
                          minor: *mut c_int,
                          revision: *mut c_int);
    pub fn clingo_signature_create(name: *const c_char,
                                   arity: uint32_t, positive: u8,
                                   signature: *mut clingo_signature_t) -> u8;
    ...
    pub fn clingo_symbol_create_number(number: c_int,
    ...
    pub fn clingo_add_string(string: *const c_char,
    ...
    pub fn clingo_model_type(model: *mut clingo_model_t,
                             type_: *mut clingo_model_type_t) -> u8;
    pub fn clingo_model_number(model: *mut clingo_model_t,
                               number: *mut uint64_t) -> u8;
    ...
    pub fn clingo_model_symbols(model: *mut clingo_model_t,
                                show: clingo_show_type_bitset_t,
                                symbols: *mut clingo_symbol_t, size: size_t)
     -> u8;
    pub fn clingo_model_contains(model: *mut clingo_model_t,
                                 atom: clingo_symbol_t, contained: *mut u8)
     -> u8;
    pub fn clingo_model_cost_size(model: *mut clingo_model_t,
                                  size: *mut size_t) -> u8;
    pub fn clingo_model_cost(model: *mut clingo_model_t, costs: *mut int64_t,
                             size: size_t) -> u8;
    ...
    pub fn clingo_model_context(model: *mut clingo_model_t,
     ...
     -> u8;
    pub fn clingo_solve_control_thread_id(control:
                                              *mut clingo_solve_control_t,
                                          id: *mut clingo_id_t) -> u8;
    pub fn clingo_solve_control_add_clause(control:
                                               *mut clingo_solve_control_t,
                                           clause:
                                               *const clingo_symbolic_literal_t,
                                           size: size_t) -> u8;
    pub fn clingo_solve_iteratively_next(handle:
                                             *mut clingo_solve_iteratively_t,
                                         model: *mut *mut clingo_model_t)
     -> u8;
    pub fn clingo_solve_iteratively_get(handle:
                                            *mut clingo_solve_iteratively_t,
                                        result:
                                            *mut clingo_solve_result_bitset_t)
     -> u8;
    pub fn clingo_solve_iteratively_close(handle:
                                              *mut clingo_solve_iteratively_t)
     -> u8;
    ...
    pub fn clingo_propagate_control_propagate(control:
                                                  *mut clingo_propagate_control_t,
                                              result: *mut u8) -> u8;
    pub fn clingo_backend_rule(backend: *mut clingo_backend_t, choice: u8,
                               head: *const clingo_atom_t, head_size: size_t,
                               body: *const clingo_literal_t,
                               body_size: size_t) -> u8;
    pub fn clingo_backend_weight_rule(backend: *mut clingo_backend_t,
                                      choice: u8, head: *const clingo_atom_t,
                                      head_size: size_t,
    ...
    pub fn clingo_backend_project(backend: *mut clingo_backend_t,
                                  atoms: *const clingo_atom_t, size: size_t)
     -> u8;
    pub fn clingo_backend_external(backend: *mut clingo_backend_t,
                                   atom: clingo_atom_t,
                                   type_: clingo_external_type_t) -> u8;
    ...
    pub fn clingo_configuration_array_at(configuration:
                                             *mut clingo_configuration_t,
                                         key: clingo_id_t, offset: size_t,
                                         subkey: *mut clingo_id_t) -> u8;
    pub fn clingo_configuration_map_size(configuration:
                                             *mut clingo_configuration_t,
                                         key: clingo_id_t, size: *mut size_t)
     -> u8;
    ...
    pub fn clingo_control_solve_iteratively(control: *mut clingo_control_t,
                                            ...
                                            assumptions_size: size_t,
                                            handle:
                                                *mut *mut clingo_solve_iteratively_t)
     -> u8;
    ...
    pub fn clingo_control_statistics(control: *mut clingo_control_t,
                                     statistics:
                                         *mut *mut clingo_statistics_t) -> u8;
    ...
    pub fn clingo_control_backend(control: *mut clingo_control_t,
                                  backend: *mut *mut clingo_backend_t) -> u8;
