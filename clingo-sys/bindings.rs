...
extern "C" {
    ...
    pub fn clingo_error_string(code: clingo_error_t)
...
/// @param[in] message the error message
    pub fn clingo_set_error(code: clingo_error_t,
...
extern "C" {
    ...
    pub fn clingo_warning_string(code: clingo_warning_t)
     -> *const ::std::os::raw::c_char;
}
...
fn bindgen_test_layout_clingo_location() {
    assert_eq!(::std::mem::size_of::<clingo_location>() , 48usize , concat ! (
               "Size of: " , stringify ! ( clingo_location ) ));
    assert_eq! (::std::mem::align_of::<clingo_location>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( clingo_location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_location ) ) . begin_file as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_location ) ,
                "::" , stringify ! ( begin_file ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_location ) ) . end_file as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_location ) ,
                "::" , stringify ! ( end_file ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_location ) ) . begin_line as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_location ) ,
                "::" , stringify ! ( begin_line ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_location ) ) . end_line as * const
                _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_location ) ,
                "::" , stringify ! ( end_line ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_location ) ) . begin_column as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_location ) ,
                "::" , stringify ! ( begin_column ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_location ) ) . end_column as *
...
/// @return the name of the signature
    pub fn clingo_signature_name(signature: clingo_signature_t)
     -> *const ::std::os::raw::c_char;
}
extern "C" {
...
/// @return whether the signature has no sign
    pub fn clingo_signature_is_positive(signature: clingo_signature_t)
     -> bool;
}
extern "C" {
...
/// @return whether the signature has a sign
    pub fn clingo_signature_is_negative(signature: clingo_signature_t)
     -> bool;
}
extern "C" {
...
/// @return whether a == b
    pub fn clingo_signature_is_equal_to(a: clingo_signature_t,
                                        b: clingo_signature_t) -> bool;
}
extern "C" {
...
/// @param[in] b second signature
/// @return whether a < b
    pub fn clingo_signature_is_less_than(a: clingo_signature_t,
                                         b: clingo_signature_t) -> bool;
}
extern "C" {
...
fn bindgen_test_layout_clingo_symbolic_literal() {
    assert_eq!(::std::mem::size_of::<clingo_symbolic_literal>() , 16usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_symbolic_literal ) ));
    assert_eq! (::std::mem::align_of::<clingo_symbolic_literal>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_symbolic_literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_symbolic_literal ) ) . symbol as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_symbolic_literal
                ) , "::" , stringify ! ( symbol ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_symbolic_literal ) ) . positive as
...
/// - ::clingo_error_bad_alloc
    pub fn clingo_symbol_create_string(string: *const ::std::os::raw::c_char,
                                       symbol: *mut clingo_symbol_t) -> bool;
}
extern "C" {
...
/// - ::clingo_error_runtime if symbol is not of type ::clingo_symbol_type_number
    pub fn clingo_symbol_number(symbol: clingo_symbol_t,
                                number: *mut ::std::os::raw::c_int) -> bool;
}
extern "C" {
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_runtime if symbol is not of type ::clingo_symbol_type_function
    pub fn clingo_symbol_is_positive(symbol: clingo_symbol_t,
                                     positive: *mut bool) -> bool;
}
extern "C" {
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_runtime if symbol is not of type ::clingo_symbol_type_function
    pub fn clingo_symbol_is_negative(symbol: clingo_symbol_t,
                                     negative: *mut bool) -> bool;
}
extern "C" {
...
/// @return the type of the symbol
    pub fn clingo_symbol_type(symbol: clingo_symbol_t)
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_bad_alloc
    pub fn clingo_symbol_to_string_size(symbol: clingo_symbol_t,
                                        size: *mut usize) -> bool;
}
extern "C" {
...
/// @return whether a == b
    pub fn clingo_symbol_is_equal_to(a: clingo_symbol_t, b: clingo_symbol_t)
     -> bool;
}
extern "C" {
...
/// @param[in] b second symbol
/// @return whether a < b
    pub fn clingo_symbol_is_less_than(a: clingo_symbol_t, b: clingo_symbol_t)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_symbolic_atoms_begin(atoms: *mut clingo_symbolic_atoms_t,
                                       ...
                                       iterator:
                                           *mut clingo_symbolic_atom_iterator_t)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_symbolic_atoms_iterator_is_equal_to(atoms:
                                                          *mut clingo_symbolic_atoms_t,
                                                      a:
...
/// @return whether the call was successful
    pub fn clingo_symbolic_atoms_is_external(atoms:
                                                 *mut clingo_symbolic_atoms_t,
                                             iterator:
                                                 clingo_symbolic_atom_iterator_t,
                                             external: *mut bool) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_symbolic_atoms_signatures_size(atoms:
                                                     *mut clingo_symbolic_atoms_t,
                                                 size: *mut usize) -> bool;
}
extern "C" {
...
/// @see clingo_symbolic_atoms_signatures_size()
    pub fn clingo_symbolic_atoms_signatures(atoms:
                                                *mut clingo_symbolic_atoms_t,
                                            signatures:
                                                *mut clingo_signature_t,
                                            size: usize) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_theory_atoms_term_arguments(atoms:
                                                  *mut clingo_theory_atoms_t,
                                              term: clingo_id_t,
                                              arguments:
                                                  *mut *const clingo_id_t,
                                              size: *mut usize) -> bool;
}
extern "C" {
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_bad_alloc
    pub fn clingo_theory_atoms_term_to_string_size(atoms:
                                                       *mut clingo_theory_atoms_t,
                                                   term: clingo_id_t,
                                                   size: *mut usize) -> bool;
}
...
/// @see clingo_theory_atoms_term_to_string_size()
    pub fn clingo_theory_atoms_term_to_string(atoms:
                                                  *mut clingo_theory_atoms_t,
                                              term: clingo_id_t,
                                              string:
...
/// @return whether the call was successful
    pub fn clingo_theory_atoms_element_tuple(atoms:
                                                 *mut clingo_theory_atoms_t,
                                             element: clingo_id_t,
...
/// @return whether the call was successful
    pub fn clingo_theory_atoms_element_condition(atoms:
                                                     *mut clingo_theory_atoms_t,
                                                 element: clingo_id_t,
                                                 condition:
                                                     *mut *const clingo_literal_t,
                                                 size: *mut usize) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_theory_atoms_element_condition_id(atoms:
                                                        *mut clingo_theory_atoms_t,
                                                    element: clingo_id_t,
                                                    condition:
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_bad_alloc
    pub fn clingo_theory_atoms_element_to_string_size(atoms:
                                                          *mut clingo_theory_atoms_t,
                                                      element: clingo_id_t,
                                                      size: *mut usize)
     -> bool;
...
/// - ::clingo_error_runtime if the size is too small
/// - ::clingo_error_bad_alloc
    pub fn clingo_theory_atoms_element_to_string(atoms:
                                                     *mut clingo_theory_atoms_t,
                                                 element: clingo_id_t,
                                                 string:
                                                     *mut ::std::os::raw::c_char,
...
/// @return whether the call was successful
    pub fn clingo_theory_atoms_size(atoms: *mut clingo_theory_atoms_t,
                                    size: *mut usize) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_theory_atoms_atom_elements(atoms:
                                                 *mut clingo_theory_atoms_t,
                                             atom: clingo_id_t,
                                             elements:
                                                 *mut *const clingo_id_t,
...
/// @return whether the call was successful
    pub fn clingo_theory_atoms_atom_has_guard(atoms:
                                                  *mut clingo_theory_atoms_t,
                                              atom: clingo_id_t,
                                              has_guard: *mut bool) -> bool;
}
extern "C" {
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_bad_alloc
    pub fn clingo_theory_atoms_atom_to_string_size(atoms:
                                                       *mut clingo_theory_atoms_t,
                                                   atom: clingo_id_t,
                                                   size: *mut usize) -> bool;
}
...
/// - ::clingo_error_runtime if the size is too small
/// - ::clingo_error_bad_alloc
    pub fn clingo_theory_atoms_atom_to_string(atoms:
                                                  *mut clingo_theory_atoms_t,
                                              atom: clingo_id_t,
                                              string:
                                                  *mut ::std::os::raw::c_char,
...
/// @return whether the call was successful
    pub fn clingo_model_type(model: *mut clingo_model_t,
                             type_: *mut clingo_model_type_t) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_model_number(model: *mut clingo_model_t, number: *mut u64)
     -> bool;
}
extern "C" {
...
/// @see clingo_model_symbols_size()
    pub fn clingo_model_symbols(model: *mut clingo_model_t,
                                show: clingo_show_type_bitset_t,
                                symbols: *mut clingo_symbol_t, size: usize)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_model_contains(model: *mut clingo_model_t,
                                 atom: clingo_symbol_t, contained: *mut bool)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_model_is_true(model: *mut clingo_model_t,
                                literal: clingo_literal_t, result: *mut bool)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_model_cost_size(model: *mut clingo_model_t,
                                  size: *mut usize) -> bool;
}
extern "C" {
...
/// @see clingo_model_optimality_proven()
    pub fn clingo_model_cost(model: *mut clingo_model_t, costs: *mut i64,
                             size: usize) -> bool;
}
extern "C" {
...
/// @see clingo_model_cost()
    pub fn clingo_model_optimality_proven(model: *mut clingo_model_t,
                                          proven: *mut bool) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_model_thread_id(model: *mut clingo_model_t,
                                  id: *mut clingo_id_t) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_solve_control_symbolic_atoms(control:
                                                   *mut clingo_solve_control_t,
                                               atoms:
                                                   *mut *mut clingo_symbolic_atoms_t)
     -> bool;
}
extern "C" {
...
/// - ::clingo_error_runtime if adding the clause fails
    pub fn clingo_solve_control_add_clause(control:
                                               *mut clingo_solve_control_t,
...
/// - ::clingo_error_runtime if solving fails
    pub fn clingo_solve_handle_model(handle: *mut clingo_solve_handle_t,
                                     model: *mut *mut clingo_model_t) -> bool;
}
extern "C" {
...
/// - ::clingo_error_bad_alloc
/// - ::clingo_error_runtime if solving fails
    pub fn clingo_solve_handle_resume(handle: *mut clingo_solve_handle_t)
     -> bool;
}
extern "C" {
...
/// - ::clingo_error_bad_alloc
/// - ::clingo_error_runtime if solving fails
    pub fn clingo_solve_handle_cancel(handle: *mut clingo_solve_handle_t)
     -> bool;
}
extern "C" {
...
/// - ::clingo_error_bad_alloc
/// - ::clingo_error_runtime if solving fails
    pub fn clingo_solve_handle_close(handle: *mut clingo_solve_handle_t)
     -> bool;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
/// @return whether the call was successful
    pub fn clingo_propagate_init_solver_literal(init:
...
/// @param[out] atoms the resulting object
/// @return whether the call was successful
    pub fn clingo_propagate_init_symbolic_atoms(init:
                                                    *mut clingo_propagate_init_t,
                                                atoms:
                                                    *mut *mut clingo_symbolic_atoms_t)
     -> bool;
...
/// @param[out] atoms the resulting object
/// @return whether the call was successful
    pub fn clingo_propagate_init_theory_atoms(init:
                                                  *mut clingo_propagate_init_t,
                                              atoms:
                                                  *mut *mut clingo_theory_atoms_t)
     -> bool;
}
extern "C" {
...
/// @see clingo_propagate_control_thread_id()
    pub fn clingo_propagate_init_number_of_threads(init:
                                                       *mut clingo_propagate_init_t)
     -> ::std::os::raw::c_int;
}
#[repr(C)]
...
/// @return the decision level
    pub fn clingo_assignment_decision_level(assignment:
...
/// @return whether the assignment is conflicting
    pub fn clingo_assignment_has_conflict(assignment:
                                              *mut clingo_assignment_t)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_assignment_level(assignment: *mut clingo_assignment_t,
                                   literal: clingo_literal_t, level: *mut u32)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_assignment_decision(assignment: *mut clingo_assignment_t,
                                      level: u32,
                                      literal: *mut clingo_literal_t) -> bool;
}
extern "C" {
...
/// @return the thread id
    pub fn clingo_propagate_control_thread_id(control:
...
/// @return the assignment
    pub fn clingo_propagate_control_assignment(control:
                                                   *mut clingo_propagate_control_t)
     -> *mut clingo_assignment_t;
}
extern "C" {
...
/// - ::clingo_error_logic if the assignment is conflicting
    pub fn clingo_propagate_control_add_literal(control:
                                                    *mut clingo_propagate_control_t,
...
/// @see clingo_propagate_control_remove_watch()
    pub fn clingo_propagate_control_add_watch(control:
                                                  *mut clingo_propagate_control_t,
                                              literal: clingo_literal_t)
     -> bool;
}
...
/// @return whether the literal is watched
    pub fn clingo_propagate_control_has_watch(control:
                                                  *mut clingo_propagate_control_t,
                                              literal: clingo_literal_t)
     -> bool;
}
...
/// @param[in] literal the literal to remove
    pub fn clingo_propagate_control_remove_watch(control:
                                                     *mut clingo_propagate_control_t,
                                                 literal: clingo_literal_t);
}
extern "C" {
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_bad_alloc
    pub fn clingo_propagate_control_add_clause(control:
                                                   *mut clingo_propagate_control_t,
                                               clause:
                                                   *const clingo_literal_t,
                                               size: usize,
                                               type_: clingo_clause_type_t,
                                               result: *mut bool) -> bool;
}
extern "C" {
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_bad_alloc
    pub fn clingo_propagate_control_propagate(control:
                                                  *mut clingo_propagate_control_t,
                                              result: *mut bool) -> bool;
}
...
fn bindgen_test_layout_clingo_propagator() {
    assert_eq!(::std::mem::size_of::<clingo_propagator>() , 32usize , concat !
               ( "Size of: " , stringify ! ( clingo_propagator ) ));
    assert_eq! (::std::mem::align_of::<clingo_propagator>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( clingo_propagator ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_propagator ) ) . init as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_propagator ) ,
                "::" , stringify ! ( init ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_propagator ) ) . propagate as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_propagator ) ,
                "::" , stringify ! ( propagate ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_propagator ) ) . undo as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_propagator ) ,
                "::" , stringify ! ( undo ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_propagator ) ) . check as * const
                _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_propagator ) ,
                "::" , stringify ! ( check ) ));
}
...
fn bindgen_test_layout_clingo_weighted_literal() {
    assert_eq!(::std::mem::size_of::<clingo_weighted_literal>() , 8usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_weighted_literal ) ));
    assert_eq! (::std::mem::align_of::<clingo_weighted_literal>() , 4usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_weighted_literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_weighted_literal ) ) . literal as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_weighted_literal
                ) , "::" , stringify ! ( literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_weighted_literal ) ) . weight as *
...
/// @return whether the call was successful; might set one of the following error codes:
/// - ::clingo_error_bad_alloc
    pub fn clingo_backend_rule(backend: *mut clingo_backend_t, choice: bool,
                               head: *const clingo_atom_t, head_size: usize,
                               body: *const clingo_literal_t,
                               body_size: usize) -> bool;
}
extern "C" {
...
/// - ::clingo_error_bad_alloc
    pub fn clingo_backend_project(backend: *mut clingo_backend_t,
                                  atoms: *const clingo_atom_t, size: usize)
     -> bool;
}
extern "C" {
...
/// - ::clingo_error_bad_alloc
    pub fn clingo_backend_external(backend: *mut clingo_backend_t,
                                   atom: clingo_atom_t,
                                   type_: clingo_external_type_t) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_configuration_root(configuration:
                                         *mut clingo_configuration_t,
                                     key: *mut clingo_id_t) -> bool;
}
extern "C" {
...
/// @param[out] type the resulting type
/// @return whether the call was successful
    pub fn clingo_configuration_type(configuration:
                                         *mut clingo_configuration_t,
                                     key: clingo_id_t,
                                     type_:
                                         *mut clingo_configuration_type_bitset_t)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_configuration_description(configuration:
                                                *mut clingo_configuration_t,
                                            key: clingo_id_t,
                                            description:
                                                *mut *const ::std::os::raw::c_char)
...
/// @param[out] size the resulting size
/// @return whether the call was successful
    pub fn clingo_configuration_array_size(configuration:
                                               *mut clingo_configuration_t,
                                           key: clingo_id_t, size: *mut usize)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_configuration_array_at(configuration:
                                             *mut clingo_configuration_t,
                                         key: clingo_id_t, offset: usize,
                                         subkey: *mut clingo_id_t) -> bool;
}
extern "C" {
...
/// @param[out] size the resulting number
/// @return whether the call was successful
    pub fn clingo_configuration_map_size(configuration:
                                             *mut clingo_configuration_t,
                                         key: clingo_id_t, size: *mut usize)
     -> bool;
}
...
/// @return whether the call was successful
    pub fn clingo_configuration_map_has_subkey(configuration:
                                                   *mut clingo_configuration_t,
                                               key: clingo_id_t,
                                               name:
                                                   *const ::std::os::raw::c_char,
...
/// @param[out] name the resulting name
/// @return whether the call was successful
    pub fn clingo_configuration_map_subkey_name(configuration:
                                                    *mut clingo_configuration_t,
                                                key: clingo_id_t,
                                                offset: usize,
                                                name:
...
/// @param[out] subkey the resulting subkey
/// @return whether the call was successful
    pub fn clingo_configuration_map_at(configuration:
                                           *mut clingo_configuration_t,
                                       key: clingo_id_t,
...
/// @return whether the call was successful
    pub fn clingo_configuration_value_is_assigned(configuration:
                                                      *mut clingo_configuration_t,
                                                  key: clingo_id_t,
                                                  assigned: *mut bool)
     -> bool;
...
/// @param[out] size the resulting size
/// @return whether the call was successful
    pub fn clingo_configuration_value_get_size(configuration:
                                                   *mut clingo_configuration_t,
                                               key: clingo_id_t,
                                               size: *mut usize) -> bool;
}
...
/// @return whether the call was successful
    pub fn clingo_configuration_value_get(configuration:
                                              *mut clingo_configuration_t,
                                          key: clingo_id_t,
...
/// @return whether the call was successful
    pub fn clingo_configuration_value_set(configuration:
                                              *mut clingo_configuration_t,
                                          key: clingo_id_t,
                                          value:
                                              *const ::std::os::raw::c_char)
...
/// @param[out] key the root key
/// @return whether the call was successful
    pub fn clingo_statistics_root(statistics: *mut clingo_statistics_t,
                                  key: *mut u64) -> bool;
}
extern "C" {
    /// Get the type of a key.
...
/// @param[out] name the resulting name
/// @return whether the call was successful
    pub fn clingo_statistics_map_subkey_name(statistics:
                                                 *mut clingo_statistics_t,
                                             key: u64, offset: usize,
                                             name:
                                                 *mut *const ::std::os::raw::c_char)
     -> bool;
...
fn bindgen_test_layout_clingo_ast_unary_operation() {
    assert_eq!(::std::mem::size_of::<clingo_ast_unary_operation>() , 72usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_unary_operation ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_unary_operation>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_unary_operation )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_unary_operation ) ) .
                unary_operator as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_unary_operation ) , "::" , stringify ! (
                unary_operator ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_unary_operation ) ) . argument
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_unary_operation ) , "::" , stringify ! ( argument )
                ));
}
...
fn bindgen_test_layout_clingo_ast_binary_operation() {
    assert_eq!(::std::mem::size_of::<clingo_ast_binary_operation>() , 136usize
               , concat ! (
               "Size of: " , stringify ! ( clingo_ast_binary_operation ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_binary_operation>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_binary_operation )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_binary_operation ) ) .
                binary_operator as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_binary_operation ) , "::" , stringify ! (
                binary_operator ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_binary_operation ) ) . left as
                * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_binary_operation ) , "::" , stringify ! ( left )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_binary_operation ) ) . right
                as * const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_binary_operation ) , "::" , stringify ! ( right )
                ));
}
...
fn bindgen_test_layout_clingo_ast_interval() {
    assert_eq!(::std::mem::size_of::<clingo_ast_interval>() , 128usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_interval )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_interval>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_interval ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_interval ) ) . left as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_interval ) ,
                "::" , stringify ! ( left ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_interval ) ) . right as *
...
fn bindgen_test_layout_clingo_ast_function() {
    assert_eq!(::std::mem::size_of::<clingo_ast_function>() , 24usize , concat
               ! ( "Size of: " , stringify ! ( clingo_ast_function ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_function>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_function ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_function ) ) . name as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_function ) ,
                "::" , stringify ! ( name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_function ) ) . arguments as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_function ) ,
                "::" , stringify ! ( arguments ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_function ) ) . size as * const
...
fn bindgen_test_layout_clingo_ast_pool() {
    assert_eq!(::std::mem::size_of::<clingo_ast_pool>() , 16usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_pool ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_pool>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( clingo_ast_pool ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_pool ) ) . arguments as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_pool ) ,
                "::" , stringify ! ( arguments ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_pool ) ) . size as * const _
...
fn bindgen_test_layout_clingo_ast_term__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<clingo_ast_term__bindgen_ty_1>() , 8usize
               , concat ! (
               "Size of: " , stringify ! ( clingo_ast_term__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_term__bindgen_ty_1>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_term__bindgen_ty_1
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) .
                symbol as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! ( symbol
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) .
                variable as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! (
                variable ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) .
                unary_operation as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! (
                unary_operation ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) .
                binary_operation as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! (
                binary_operation ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) .
                interval as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! (
                interval ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) .
                function as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! (
                function ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) .
                external_function as * const _ as usize } , 0usize , concat !
                (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! (
                external_function ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term__bindgen_ty_1 ) ) . pool
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_term__bindgen_ty_1 ) , "::" , stringify ! ( pool )
                ));
}
...
fn bindgen_test_layout_clingo_ast_term() {
    assert_eq!(::std::mem::size_of::<clingo_ast_term>() , 64usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_term ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_term>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( clingo_ast_term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term ) ) . location as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_term ) ,
                "::" , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_term ) ) . type_ as * const _
...
fn bindgen_test_layout_clingo_ast_csp_product_term() {
    assert_eq!(::std::mem::size_of::<clingo_ast_csp_product_term>() , 120usize
               , concat ! (
               "Size of: " , stringify ! ( clingo_ast_csp_product_term ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_csp_product_term>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_csp_product_term )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_product_term ) ) .
                location as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_csp_product_term ) , "::" , stringify ! ( location
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_product_term ) ) .
                coefficient as * const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_csp_product_term ) , "::" , stringify ! (
                coefficient ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_product_term ) ) .
                variable as * const _ as usize } , 112usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_csp_product_term ) , "::" , stringify ! ( variable
                ) ));
}
...
fn bindgen_test_layout_clingo_ast_csp_sum_term() {
    assert_eq!(::std::mem::size_of::<clingo_ast_csp_sum_term>() , 64usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_csp_sum_term ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_csp_sum_term>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_csp_sum_term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_sum_term ) ) . location as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_csp_sum_term
                ) , "::" , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_sum_term ) ) . terms as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_csp_sum_term
                ) , "::" , stringify ! ( terms ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_sum_term ) ) . size as *
...
fn bindgen_test_layout_clingo_ast_csp_guard() {
    assert_eq!(::std::mem::size_of::<clingo_ast_csp_guard>() , 72usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_csp_guard )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_csp_guard>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_csp_guard ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_guard ) ) . comparison as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_csp_guard )
                , "::" , stringify ! ( comparison ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_guard ) ) . term as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_csp_guard )
                , "::" , stringify ! ( term ) ));
}
...
fn bindgen_test_layout_clingo_ast_csp_literal() {
    assert_eq!(::std::mem::size_of::<clingo_ast_csp_literal>() , 80usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_csp_literal )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_csp_literal>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_csp_literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_literal ) ) . term as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_csp_literal
                ) , "::" , stringify ! ( term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_literal ) ) . guards as *
                const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_csp_literal
                ) , "::" , stringify ! ( guards ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_csp_literal ) ) . size as *
...
fn bindgen_test_layout_clingo_ast_id() {
    assert_eq!(::std::mem::size_of::<clingo_ast_id>() , 56usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_id ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_id>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_id ) ) . location as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_id ) , "::"
                , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_id ) ) . id as * const _ as
...
fn bindgen_test_layout_clingo_ast_comparison() {
    assert_eq!(::std::mem::size_of::<clingo_ast_comparison>() , 136usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_comparison )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_comparison>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_comparison ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_comparison ) ) . comparison as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_comparison )
                , "::" , stringify ! ( comparison ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_comparison ) ) . left as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_comparison )
                , "::" , stringify ! ( left ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_comparison ) ) . right as *
                const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_comparison )
                , "::" , stringify ! ( right ) ));
}
...
fn bindgen_test_layout_clingo_ast_literal__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<clingo_ast_literal__bindgen_ty_1>() ,
               8usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_literal__bindgen_ty_1 )
               ));
    ...
    assert_eq! (unsafe {
                ...
                "Alignment of field: " , stringify ! (
                clingo_ast_literal__bindgen_ty_1 ) , "::" , stringify ! (
                boolean ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_literal__bindgen_ty_1 ) ) .
                symbol as * const _ as usize } , 0usize , concat ! (
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_literal__bindgen_ty_1 ) ) .
                comparison as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_literal__bindgen_ty_1 ) , "::" , stringify ! (
                comparison ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_literal__bindgen_ty_1 ) ) .
                csp_literal as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_literal__bindgen_ty_1 ) , "::" , stringify ! (
                csp_literal ) ));
}
...
fn bindgen_test_layout_clingo_ast_literal() {
    assert_eq!(::std::mem::size_of::<clingo_ast_literal>() , 64usize , concat
               ! ( "Size of: " , stringify ! ( clingo_ast_literal ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_literal>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( clingo_ast_literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_literal ) ) . location as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_literal ) ,
                "::" , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_literal ) ) . sign as * const
                _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_literal ) ,
                "::" , stringify ! ( sign ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_literal ) ) . type_ as * const
...
fn bindgen_test_layout_clingo_ast_aggregate_guard() {
    assert_eq!(::std::mem::size_of::<clingo_ast_aggregate_guard>() , 72usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_aggregate_guard ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_aggregate_guard>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_aggregate_guard )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_aggregate_guard ) ) .
                comparison as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_aggregate_guard ) , "::" , stringify ! ( comparison
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_aggregate_guard ) ) . term as
                * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_aggregate_guard ) , "::" , stringify ! ( term ) ));
}
...
fn bindgen_test_layout_clingo_ast_conditional_literal() {
    assert_eq!(::std::mem::size_of::<clingo_ast_conditional_literal>() ,
               80usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_conditional_literal )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_conditional_literal>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_conditional_literal
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_conditional_literal ) ) .
                literal as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_conditional_literal ) , "::" , stringify ! (
                literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_conditional_literal ) ) .
                condition as * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_conditional_literal ) , "::" , stringify ! (
                condition ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_conditional_literal ) ) . size
                as * const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_conditional_literal ) , "::" , stringify ! ( size )
                ));
}
...
fn bindgen_test_layout_clingo_ast_aggregate() {
    assert_eq!(::std::mem::size_of::<clingo_ast_aggregate>() , 32usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_aggregate )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_aggregate>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_aggregate ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_aggregate ) ) . elements as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_aggregate )
                , "::" , stringify ! ( elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_aggregate ) ) . size as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_aggregate )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_aggregate ) ) . left_guard as
                * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_aggregate )
                , "::" , stringify ! ( left_guard ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_aggregate ) ) . right_guard as
...
fn bindgen_test_layout_clingo_ast_body_aggregate_element() {
    assert_eq!(::std::mem::size_of::<clingo_ast_body_aggregate_element>() ,
               32usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_body_aggregate_element )
               ));
    ...
    assert_eq! (unsafe {
                ...
                tuple as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate_element ) , "::" , stringify ! (
                tuple ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate_element ) ) .
                tuple_size as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate_element ) , "::" , stringify ! (
                tuple_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate_element ) ) .
                condition as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate_element ) , "::" , stringify ! (
                condition ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate_element ) ) .
                condition_size as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate_element ) , "::" , stringify ! (
                condition_size ) ));
}
...
pub type clingo_ast_body_aggregate_element_t =
    clingo_ast_body_aggregate_element;
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_clingo_ast_body_aggregate() {
    assert_eq!(::std::mem::size_of::<clingo_ast_body_aggregate>() , 40usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_body_aggregate ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_body_aggregate>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_body_aggregate )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate ) ) . function
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate ) , "::" , stringify ! ( function )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate ) ) . elements
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate ) , "::" , stringify ! ( elements )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate ) ) . size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate ) ) .
                left_guard as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate ) , "::" , stringify ! ( left_guard
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_aggregate ) ) .
                right_guard as * const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_aggregate ) , "::" , stringify ! ( right_guard
                ) ));
}
...
fn bindgen_test_layout_clingo_ast_head_aggregate_element() {
    assert_eq!(::std::mem::size_of::<clingo_ast_head_aggregate_element>() ,
               96usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_head_aggregate_element )
               ));
    ...
    assert_eq! (unsafe {
                ...
                tuple as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_aggregate_element ) , "::" , stringify ! (
                tuple ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_aggregate_element ) ) .
                tuple_size as * const _ as usize } , 8usize , concat ! (
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_aggregate_element ) ) .
                conditional_literal as * const _ as usize } , 16usize , concat
                ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_aggregate_element ) , "::" , stringify ! (
                conditional_literal ) ));
...
pub type clingo_ast_head_aggregate_element_t =
    clingo_ast_head_aggregate_element;
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_clingo_ast_head_aggregate() {
    assert_eq!(::std::mem::size_of::<clingo_ast_head_aggregate>() , 40usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_head_aggregate ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_head_aggregate>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_head_aggregate )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_aggregate ) ) . function
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_aggregate ) , "::" , stringify ! ( function )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_aggregate ) ) . elements
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_aggregate ) , "::" , stringify ! ( elements )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_aggregate ) ) . size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_aggregate ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_aggregate ) ) .
                left_guard as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_aggregate ) , "::" , stringify ! ( left_guard
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_aggregate ) ) .
                right_guard as * const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_aggregate ) , "::" , stringify ! ( right_guard
                ) ));
}
...
fn bindgen_test_layout_clingo_ast_disjunction() {
    assert_eq!(::std::mem::size_of::<clingo_ast_disjunction>() , 16usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_disjunction )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_disjunction>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_disjunction ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjunction ) ) . elements as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_disjunction
                ) , "::" , stringify ! ( elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjunction ) ) . size as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_disjunction
                ) , "::" , stringify ! ( size ) ));
}
...
fn bindgen_test_layout_clingo_ast_disjoint_element() {
    assert_eq!(::std::mem::size_of::<clingo_ast_disjoint_element>() , 144usize
               , concat ! (
               "Size of: " , stringify ! ( clingo_ast_disjoint_element ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_disjoint_element>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_disjoint_element )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint_element ) ) .
                location as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_disjoint_element ) , "::" , stringify ! ( location
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint_element ) ) . tuple
                as * const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_disjoint_element ) , "::" , stringify ! ( tuple )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint_element ) ) .
                tuple_size as * const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_disjoint_element ) , "::" , stringify ! (
                tuple_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint_element ) ) . term as
                * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_disjoint_element ) , "::" , stringify ! ( term )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint_element ) ) .
                condition as * const _ as usize } , 128usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_disjoint_element ) , "::" , stringify ! ( condition
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint_element ) ) .
                condition_size as * const _ as usize } , 136usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_disjoint_element ) , "::" , stringify ! (
                condition_size ) ));
}
...
fn bindgen_test_layout_clingo_ast_disjoint() {
    assert_eq!(::std::mem::size_of::<clingo_ast_disjoint>() , 16usize , concat
               ! ( "Size of: " , stringify ! ( clingo_ast_disjoint ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_disjoint>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_disjoint ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint ) ) . elements as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_disjoint ) ,
                "::" , stringify ! ( elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_disjoint ) ) . size as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_disjoint ) ,
                "::" , stringify ! ( size ) ));
}
...
fn bindgen_test_layout_clingo_ast_theory_function() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_function>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_function ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_theory_function>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_theory_function )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_function ) ) . name as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_function ) , "::" , stringify ! ( name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_function ) ) .
                arguments as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_function ) , "::" , stringify ! ( arguments
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_function ) ) . size as
                * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_function ) , "::" , stringify ! ( size ) ));
}
...
fn bindgen_test_layout_clingo_ast_theory_term_array() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_term_array>() , 16usize
               , concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_term_array ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_theory_term_array>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_theory_term_array )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term_array ) ) . terms
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term_array ) , "::" , stringify ! ( terms )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term_array ) ) . size
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term_array ) , "::" , stringify ! ( size )
                ));
}
...
fn bindgen_test_layout_clingo_ast_theory_unparsed_term() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_unparsed_term>() ,
               16usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_unparsed_term )
               ));
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_unparsed_term ) ) .
                elements as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_unparsed_term ) , "::" , stringify ! (
                elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_unparsed_term ) ) .
                size as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_unparsed_term ) , "::" , stringify ! ( size
                ) ));
}
...
fn bindgen_test_layout_clingo_ast_theory_term__bindgen_ty_1() {
    ...
    assert_eq! (unsafe {
                ...
                . symbol as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term__bindgen_ty_1 ) , "::" , stringify ! (
                symbol ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term__bindgen_ty_1 ) )
                . variable as * const _ as usize } , 0usize , concat ! (
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term__bindgen_ty_1 ) )
                . list as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term__bindgen_ty_1 ) , "::" , stringify ! (
                list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term__bindgen_ty_1 ) )
                . set as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term__bindgen_ty_1 ) , "::" , stringify ! (
                set ) ));
    assert_eq! (unsafe {
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term__bindgen_ty_1 ) )
                . unparsed_term as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term__bindgen_ty_1 ) , "::" , stringify ! (
                unparsed_term ) ));
}
...
fn bindgen_test_layout_clingo_ast_theory_term() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_term>() , 64usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_theory_term )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_theory_term>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_theory_term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term ) ) . location as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_theory_term
                ) , "::" , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term ) ) . type_ as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_theory_term
                ) , "::" , stringify ! ( type_ ) ));
}
...
fn bindgen_test_layout_clingo_ast_theory_unparsed_term_element() {
    ...
    assert_eq! (unsafe {
                ...
                ) . operators as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_unparsed_term_element ) , "::" , stringify !
                ( operators ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_unparsed_term_element )
                ) . size as * const _ as usize } , 8usize , concat ! (
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_unparsed_term_element )
                ) . term as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_unparsed_term_element ) , "::" , stringify !
                ( term ) ));
}
...
pub type clingo_ast_theory_unparsed_term_element_t =
    clingo_ast_theory_unparsed_term_element;
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_clingo_ast_theory_atom_element() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_atom_element>() ,
               32usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_atom_element )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_theory_atom_element>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_theory_atom_element
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_element ) ) .
                tuple as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_element ) , "::" , stringify ! ( tuple
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_element ) ) .
                tuple_size as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_element ) , "::" , stringify ! (
                tuple_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_element ) ) .
                condition as * const _ as usize } , 16usize , concat ! (
...
fn bindgen_test_layout_clingo_ast_theory_guard() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_guard>() , 72usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_guard ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_theory_guard>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_theory_guard ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_guard ) ) .
                operator_name as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_theory_guard
                ) , "::" , stringify ! ( operator_name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_guard ) ) . term as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_theory_guard
                ) , "::" , stringify ! ( term ) ));
}
...
fn bindgen_test_layout_clingo_ast_theory_atom() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_atom>() , 88usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_theory_atom )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_theory_atom>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_theory_atom ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom ) ) . term as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_theory_atom
                ) , "::" , stringify ! ( term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom ) ) . elements as
                * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_theory_atom
                ) , "::" , stringify ! ( elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom ) ) . size as *
                const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_theory_atom
                ) , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom ) ) . guard as *
...
fn bindgen_test_layout_clingo_ast_head_literal__bindgen_ty_1() {
    ...
    assert_eq! (unsafe {
                ...
                . literal as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_literal__bindgen_ty_1 ) , "::" , stringify ! (
                literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_literal__bindgen_ty_1 ) )
                . disjunction as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_literal__bindgen_ty_1 ) , "::" , stringify ! (
                disjunction ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_literal__bindgen_ty_1 ) )
                . aggregate as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_literal__bindgen_ty_1 ) , "::" , stringify ! (
                aggregate ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_literal__bindgen_ty_1 ) )
                . head_aggregate as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_literal__bindgen_ty_1 ) , "::" , stringify ! (
                head_aggregate ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_literal__bindgen_ty_1 ) )
                . theory_atom as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_head_literal__bindgen_ty_1 ) , "::" , stringify ! (
                theory_atom ) ));
}
...
fn bindgen_test_layout_clingo_ast_head_literal() {
    assert_eq!(::std::mem::size_of::<clingo_ast_head_literal>() , 64usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_head_literal ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_head_literal>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_head_literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_literal ) ) . location as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_head_literal
                ) , "::" , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_head_literal ) ) . type_ as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_head_literal
                ) , "::" , stringify ! ( type_ ) ));
}
...
fn bindgen_test_layout_clingo_ast_body_literal__bindgen_ty_1() {
    ...
    assert_eq! (unsafe {
                ...
                . literal as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_literal__bindgen_ty_1 ) , "::" , stringify ! (
                literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_literal__bindgen_ty_1 ) )
                . conditional as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_literal__bindgen_ty_1 ) , "::" , stringify ! (
                conditional ) ));
    assert_eq! (unsafe {
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_literal__bindgen_ty_1 ) )
                . body_aggregate as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_literal__bindgen_ty_1 ) , "::" , stringify ! (
                body_aggregate ) ));
    assert_eq! (unsafe {
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_literal__bindgen_ty_1 ) )
                . disjoint as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_body_literal__bindgen_ty_1 ) , "::" , stringify ! (
                disjoint ) ));
}
...
fn bindgen_test_layout_clingo_ast_body_literal() {
    assert_eq!(::std::mem::size_of::<clingo_ast_body_literal>() , 64usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_body_literal ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_body_literal>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_body_literal ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_literal ) ) . location as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_body_literal
                ) , "::" , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_literal ) ) . sign as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_body_literal
                ) , "::" , stringify ! ( sign ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_body_literal ) ) . type_ as *
...
fn bindgen_test_layout_clingo_ast_theory_operator_definition() {
    ...
    assert_eq! (unsafe {
                ...
                . location as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_operator_definition ) , "::" , stringify ! (
                location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_operator_definition ) )
                . name as * const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_operator_definition ) , "::" , stringify ! (
                name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_operator_definition ) )
                . priority as * const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_operator_definition ) , "::" , stringify ! (
                priority ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_operator_definition ) )
                . type_ as * const _ as usize } , 60usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_operator_definition ) , "::" , stringify ! (
                type_ ) ));
}
...
pub type clingo_ast_theory_operator_definition_t =
    clingo_ast_theory_operator_definition;
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_clingo_ast_theory_term_definition() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_term_definition>() ,
               72usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_term_definition )
               ));
    ...
    assert_eq! (unsafe {
                ...
                location as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term_definition ) , "::" , stringify ! (
                location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term_definition ) ) .
                name as * const _ as usize } , 48usize , concat ! (
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term_definition ) ) .
                operators as * const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term_definition ) , "::" , stringify ! (
                operators ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_term_definition ) ) .
                size as * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_term_definition ) , "::" , stringify ! (
                size ) ));
}
...
pub type clingo_ast_theory_term_definition_t =
    clingo_ast_theory_term_definition;
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_clingo_ast_theory_guard_definition() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_guard_definition>() ,
               24usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_guard_definition
               ) ));
    ...
    assert_eq! (unsafe {
                ...
                term as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_guard_definition ) , "::" , stringify ! (
                term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_guard_definition ) ) .
                operators as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_guard_definition ) , "::" , stringify ! (
                operators ) ));
    assert_eq! (unsafe {
...
pub type clingo_ast_theory_guard_definition_t =
    clingo_ast_theory_guard_definition;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
...
fn bindgen_test_layout_clingo_ast_theory_atom_definition() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_atom_definition>() ,
               88usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_atom_definition )
               ));
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_definition ) ) .
                location as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_definition ) , "::" , stringify ! (
                location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_definition ) ) .
                type_ as * const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_definition ) , "::" , stringify ! (
                type_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_definition ) ) .
                name as * const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_definition ) , "::" , stringify ! (
                name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_definition ) ) .
                arity as * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_definition ) , "::" , stringify ! (
                arity ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_definition ) ) .
                elements as * const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_definition ) , "::" , stringify ! (
                elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_atom_definition ) ) .
                guard as * const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_atom_definition ) , "::" , stringify ! (
                guard ) ));
}
...
pub type clingo_ast_theory_atom_definition_t =
    clingo_ast_theory_atom_definition;
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_clingo_ast_theory_definition() {
    assert_eq!(::std::mem::size_of::<clingo_ast_theory_definition>() , 40usize
               , concat ! (
               "Size of: " , stringify ! ( clingo_ast_theory_definition ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_theory_definition>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_ast_theory_definition )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_definition ) ) . name
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_definition ) , "::" , stringify ! ( name )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_definition ) ) . terms
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_definition ) , "::" , stringify ! ( terms )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_definition ) ) .
                terms_size as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_definition ) , "::" , stringify ! (
                terms_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_definition ) ) . atoms
                as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_definition ) , "::" , stringify ! ( atoms )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_theory_definition ) ) .
                atoms_size as * const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_theory_definition ) , "::" , stringify ! (
                atoms_size ) ));
}
...
fn bindgen_test_layout_clingo_ast_rule() {
    assert_eq!(::std::mem::size_of::<clingo_ast_rule>() , 80usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_rule ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_rule>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( clingo_ast_rule ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_rule ) ) . head as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_rule ) ,
                "::" , stringify ! ( head ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_rule ) ) . body as * const _
                as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_rule ) ,
                "::" , stringify ! ( body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_rule ) ) . size as * const _
...
fn bindgen_test_layout_clingo_ast_definition() {
    assert_eq!(::std::mem::size_of::<clingo_ast_definition>() , 80usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_definition )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_definition>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_definition ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_definition ) ) . name as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_definition )
                , "::" , stringify ! ( name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_definition ) ) . value as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_definition )
                , "::" , stringify ! ( value ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_definition ) ) . is_default as
                * const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_definition )
...
fn bindgen_test_layout_clingo_ast_show_signature() {
    assert_eq!(::std::mem::size_of::<clingo_ast_show_signature>() , 16usize ,
               concat ! (
               "Size of: " , stringify ! ( clingo_ast_show_signature ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_show_signature>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_show_signature )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_show_signature ) ) . signature
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_show_signature ) , "::" , stringify ! ( signature )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_show_signature ) ) . csp as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_show_signature ) , "::" , stringify ! ( csp ) ));
}
...
fn bindgen_test_layout_clingo_ast_show_term() {
    assert_eq!(::std::mem::size_of::<clingo_ast_show_term>() , 88usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_show_term )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_show_term>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_show_term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_show_term ) ) . term as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_show_term )
                , "::" , stringify ! ( term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_show_term ) ) . body as *
                const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_show_term )
                , "::" , stringify ! ( body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_show_term ) ) . size as *
                const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_show_term )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_show_term ) ) . csp as * const
...
fn bindgen_test_layout_clingo_ast_minimize() {
    assert_eq!(::std::mem::size_of::<clingo_ast_minimize>() , 160usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_minimize )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_minimize>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_minimize ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_minimize ) ) . weight as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_minimize ) ,
                "::" , stringify ! ( weight ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_minimize ) ) . priority as *
                const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_minimize ) ,
                "::" , stringify ! ( priority ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_minimize ) ) . tuple as *
                const _ as usize } , 128usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_minimize ) ,
                "::" , stringify ! ( tuple ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_minimize ) ) . tuple_size as *
                const _ as usize } , 136usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_minimize ) ,
                "::" , stringify ! ( tuple_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_minimize ) ) . body as * const
                _ as usize } , 144usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_minimize ) ,
                "::" , stringify ! ( body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_minimize ) ) . body_size as *
...
fn bindgen_test_layout_clingo_ast_script() {
    assert_eq!(::std::mem::size_of::<clingo_ast_script>() , 16usize , concat !
               ( "Size of: " , stringify ! ( clingo_ast_script ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_script>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( clingo_ast_script ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_script ) ) . type_ as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_script ) ,
                "::" , stringify ! ( type_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_script ) ) . code as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_script ) ,
                "::" , stringify ! ( code ) ));
}
...
fn bindgen_test_layout_clingo_ast_program() {
    assert_eq!(::std::mem::size_of::<clingo_ast_program>() , 24usize , concat
               ! ( "Size of: " , stringify ! ( clingo_ast_program ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_program>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( clingo_ast_program ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_program ) ) . name as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_program ) ,
                "::" , stringify ! ( name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_program ) ) . parameters as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_program ) ,
                "::" , stringify ! ( parameters ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_program ) ) . size as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_program ) ,
                "::" , stringify ! ( size ) ));
}
...
fn bindgen_test_layout_clingo_ast_external() {
    assert_eq!(::std::mem::size_of::<clingo_ast_external>() , 80usize , concat
               ! ( "Size of: " , stringify ! ( clingo_ast_external ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_external>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_external ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_external ) ) . atom as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_external ) ,
                "::" , stringify ! ( atom ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_external ) ) . body as * const
                _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_external ) ,
                "::" , stringify ! ( body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_external ) ) . size as * const
...
fn bindgen_test_layout_clingo_ast_edge() {
    assert_eq!(::std::mem::size_of::<clingo_ast_edge>() , 144usize , concat !
               ( "Size of: " , stringify ! ( clingo_ast_edge ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_edge>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( clingo_ast_edge ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_edge ) ) . u as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_edge ) ,
                "::" , stringify ! ( u ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_edge ) ) . v as * const _ as
                usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_edge ) ,
                "::" , stringify ! ( v ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_edge ) ) . body as * const _
                as usize } , 128usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_edge ) ,
                "::" , stringify ! ( body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_edge ) ) . size as * const _
...
fn bindgen_test_layout_clingo_ast_heuristic() {
    assert_eq!(::std::mem::size_of::<clingo_ast_heuristic>() , 272usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_heuristic )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_heuristic>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_heuristic ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_heuristic ) ) . atom as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_heuristic )
                , "::" , stringify ! ( atom ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_heuristic ) ) . body as *
                const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_heuristic )
                , "::" , stringify ! ( body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_heuristic ) ) . size as *
                const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_heuristic )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_heuristic ) ) . bias as *
                const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_heuristic )
                , "::" , stringify ! ( bias ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_heuristic ) ) . priority as *
                const _ as usize } , 144usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_heuristic )
                , "::" , stringify ! ( priority ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_heuristic ) ) . modifier as *
...
fn bindgen_test_layout_clingo_ast_project() {
    assert_eq!(::std::mem::size_of::<clingo_ast_project>() , 80usize , concat
               ! ( "Size of: " , stringify ! ( clingo_ast_project ) ));
    assert_eq! (::std::mem::align_of::<clingo_ast_project>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( clingo_ast_project ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_project ) ) . atom as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_project ) ,
                "::" , stringify ! ( atom ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_project ) ) . body as * const
                _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_project ) ,
                "::" , stringify ! ( body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_project ) ) . size as * const
                _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_project ) ,
                "::" , stringify ! ( size ) ));
}
...
fn bindgen_test_layout_clingo_ast_statement__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<clingo_ast_statement__bindgen_ty_1>() ,
               8usize , concat ! (
               "Size of: " , stringify ! ( clingo_ast_statement__bindgen_ty_1
               ) ));
    ...
    assert_eq! (unsafe {
                ...
                rule as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                rule ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                definition as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                definition ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                show_signature as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                show_signature ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                show_term as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                show_term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                minimize as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                minimize ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                script as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                script ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                program as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                program ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                external as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                external ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                edge as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                edge ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                heuristic as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                heuristic ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                project_atom as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                project_atom ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                project_signature as * const _ as usize } , 0usize , concat !
                (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                project_signature ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement__bindgen_ty_1 ) ) .
                theory_definition as * const _ as usize } , 0usize , concat !
                (
                "Alignment of field: " , stringify ! (
                clingo_ast_statement__bindgen_ty_1 ) , "::" , stringify ! (
                theory_definition ) ));
...
fn bindgen_test_layout_clingo_ast_statement() {
    assert_eq!(::std::mem::size_of::<clingo_ast_statement>() , 64usize ,
               concat ! ( "Size of: " , stringify ! ( clingo_ast_statement )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ast_statement>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( clingo_ast_statement ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement ) ) . location as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_statement )
                , "::" , stringify ! ( location ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ast_statement ) ) . type_ as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_ast_statement )
                , "::" , stringify ! ( type_ ) ));
}
...
/// @return whether the call was successful
    pub fn clingo_program_builder_begin(builder:
                                            *mut clingo_program_builder_t)
     -> bool;
}
extern "C" {
...
/// @param builder the target program builder
/// @return whether the call was successful
    pub fn clingo_program_builder_end(builder: *mut clingo_program_builder_t)
     -> bool;
}
...
fn bindgen_test_layout_clingo_ground_program_observer() {
    assert_eq!(::std::mem::size_of::<clingo_ground_program_observer>() ,
               160usize , concat ! (
               "Size of: " , stringify ! ( clingo_ground_program_observer )
               ));
    assert_eq! (::std::mem::align_of::<clingo_ground_program_observer>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_ground_program_observer
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                init_program as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                init_program ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                begin_step as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                begin_step ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                end_step as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                end_step ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) . rule
                as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! ( rule )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                weight_rule as * const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                weight_rule ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                minimize as * const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                minimize ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                project as * const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                project ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                output_atom as * const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                output_atom ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                output_term as * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                output_term ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                output_csp as * const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                output_csp ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                external as * const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                external ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                assume as * const _ as usize } , 88usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! ( assume
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                heuristic as * const _ as usize } , 96usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                heuristic ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                acyc_edge as * const _ as usize } , 104usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                acyc_edge ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                theory_term_number as * const _ as usize } , 112usize , concat
                ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                theory_term_number ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                theory_term_string as * const _ as usize } , 120usize , concat
                ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                theory_term_string ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                theory_term_compound as * const _ as usize } , 128usize ,
                concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                theory_element as * const _ as usize } , 136usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                theory_element ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                theory_atom as * const _ as usize } , 144usize , concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
                theory_atom ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_ground_program_observer ) ) .
                theory_atom_with_guard as * const _ as usize } , 152usize ,
                concat ! (
                "Alignment of field: " , stringify ! (
                clingo_ground_program_observer ) , "::" , stringify ! (
...
fn bindgen_test_layout_clingo_part() {
    assert_eq!(::std::mem::size_of::<clingo_part>() , 24usize , concat ! (
               "Size of: " , stringify ! ( clingo_part ) ));
    assert_eq! (::std::mem::align_of::<clingo_part>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( clingo_part ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_part ) ) . name as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_part ) , "::" ,
                stringify ! ( name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_part ) ) . params as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( clingo_part ) , "::" ,
                stringify ! ( params ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const clingo_part ) ) . size as * const _ as
...
pub type clingo_symbol_callback_t =
    ::std::option::Option<unsafe extern "C" fn(symbols:
...
/// - ::clingo_error_runtime if argument parsing fails
    pub fn clingo_control_new(arguments: *const *const ::std::os::raw::c_char,
                              arguments_size: usize, logger: clingo_logger_t,
                              logger_data: *mut ::std::os::raw::c_void,
                              message_limit: ::std::os::raw::c_uint,
                              control: *mut *mut clingo_control_t) -> bool;
}
extern "C" {
...
/// - ::clingo_error_runtime if parsing or checking fails
    pub fn clingo_control_load(control: *mut clingo_control_t,
                               file: *const ::std::os::raw::c_char) -> bool;
}
extern "C" {
...
/// - ::clingo_error_runtime if parsing fails
    pub fn clingo_control_add(control: *mut clingo_control_t,
                              ...
                              program: *const ::std::os::raw::c_char) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_control_configuration(control: *mut clingo_control_t,
                                        configuration:
                                            *mut *mut clingo_configuration_t)
     -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_control_use_enumeration_assumption(control:
                                                         *mut clingo_control_t,
                                                     enable: bool) -> bool;
}
extern "C" {
...
/// @return whether the call was successful
    pub fn clingo_control_register_observer(control: *mut clingo_control_t,
                                            observer:
                                                *const clingo_ground_program_observer_t,
                                            replace: bool,
                                            data: *mut ::std::os::raw::c_void)
     -> bool;
}
...
/// @return whether the call was successful
    pub fn clingo_control_program_builder(control: *mut clingo_control_t,
                                          builder:
                                              *mut *mut clingo_program_builder_t)
     -> bool;
}
